...
export default class TurboDownloader {
    protected options: TurboDownloaderOptions;
    protected started: boolean = false;
    protected aborted: boolean = false;
    protected abortSaveProgress: boolean = false;
            ...
            await PromisePool
                ...
                .process(async chunk => {
                    ...
                    while (retries <= this.options.retryCount) {
                        try {
                            await this.downloadChunk(chunk, (newChunk) => {
    ...
    private async downloadChunk(chunk: DownloadingChunk, progressCallback: (chunk: DownloadingChunk) => void, abortHandler: (abort: () => void) => void) {
